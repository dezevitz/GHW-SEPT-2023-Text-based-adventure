...
def scene2():
    ...
    while sceneDone == "false":
        action = input("What do you want to do? ").lower()
        if action == "l":
            print("There is a path to your east and west. The door to your home is behind you.")
        if action in ["e", "east"]:
            frankieScene()
            sceneDone = "true"
        if action in ["w", "west"]:
...
def frankieScene():
    ...
    while sceneDone == "false":
        action = input("What do you want to do? ").lower()
        if action == "l":
            print("You see frankie standing on the edge of the river looking frustrated and nervous.")
        ...
        if action == "x frankie":
            print("Frankie is standing on the edge of the river looking frustrated and nervous.")
...
def adaScene():
    ...
    while sceneDone == "false":
        ...
        if action == "talk to ada":
            print("Ada: Geez I skipped breakfast to code this hackathon project. I am so hungry!")
